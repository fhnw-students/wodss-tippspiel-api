...
public interface GameRepository extends JpaRepository<Game, Long> {
    ...
    @Query("select new ch.fhnw.edu.wodss.tippspielapi.controller.dto.UserGameDto(g, t) from Game g left join Tip t on t.game.id = g.id")
    List<UserGameDto> findAllUserGames();
